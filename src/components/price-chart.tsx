...
export function PriceChart({ data }: { data: Point[] }) {
  ...
  if (!data.length) return <div className="chart-empty">Price history unavailable</div>;
  return <div ref={container} className="price-chart" aria-label="Six month price and moving average chart" />;
}
